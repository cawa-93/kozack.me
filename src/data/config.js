// const contacts = [
// 	{
// 		type: 'Telegram', url: 'https://t.me/kozack',
// 		label: 'Telegram',
// 		icon: '<svg width="24" height="24" viewBox="0 0 24 24"><path
// 		d = "M9.78,18.65L10.06,14.42L17.74,7.5C18.08,7.19 17.67,7.04 17.22,7.31L7.74,13.3L3.64,12C2.76,11.75 2.75,11.14
// 		3.84,
// 		10.7L19
// 		.81,
// 		4.54C20
...
// 		.38,
// 		18.46 10.19,
// 		18.65 9.78, 18.65Z" /></svg>', },
//
// 	{
// 		type: 'Habr', url: 'https://habr.com/ru/users/kozack/posts', label: 'Blog on Habr', icon:
// 			'<svg width="24" height="24" viewBox="0 0 24 24"><path d="m14.68402,7.09114c-1.78656,-0.12905 -3.51322,0.67301
// -4.56701,2.12145l0,-9.21259l-5.11701,0l0,23.5717l5.11701,0l0,-8.6233c0,-2.0626 1.17858,-3.0447
// 2.6027,-3.0447c1.5518,0 2.53399,1.0509 2.53399,2.9464l0,8.7216l5.117,0l0,-10.5287c0,-3.71255 -2.4849,-5.95186
// -5.68668,-5.95186z" /></svg>', }, { type: 'Facebook', url: 'https://m.me/alex.kozack', label: 'Facebook Messenger',
// icon: '<svg width="24" height="24" viewBox="0 0 24 24"><path d="M12,2C6.36,2 2,6.13 2,11.7C2,14.61 3.19,17.14
// 5.14,18.87C5.3,19 5.4,19.22 5.41,19.44L5.46,21.22C5.5,21.79 6.07,22.16 6.59,21.93L8.57,21.06C8.74,21 8.93,20.97
// 9.1,21C10,21.27 11,21.4 12,21.4C17.64,21.4 22,17.27 22,11.7C22,6.13 17.64,2 12,2M18,9.46L15.07,14.13C14.6,14.86
// 13.6,15.05 12.9,14.5L10.56,12.77C10.35,12.61 10.05,12.61 9.84,12.77L6.68,15.17C6.26,15.5 5.71,15
// 6,14.54L8.93,9.87C9.4,9.14 10.4,8.95 11.1,9.47L13.44,11.23C13.66,11.39 13.95,11.39 14.16,11.23L17.32,8.83C17.74,8.5
// 18.29,9 18,9.46Z" /></svg>', }, ];
